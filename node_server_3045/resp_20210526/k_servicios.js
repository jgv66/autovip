    ...
    vehiculosKilometraje: function(sql) {
        ...
        const query = `
            SELECT	ve.id as idvehiculo,ve.marca,ve.modelo,ve.anno,ve.patente
                    ,cond.id as idconductor, cond.nombres
                ...
                begin transaction;
                    ...
                    if exists (select * from k_auto_detenidos with (nolock) where idvehiculo = ${ body.idvehiculo }) begin
                        ...
                        set idconductor = ${ body.idconductor},
                            ...
                            fechareparacion = '${body.fechareparacion }',
                            fecharegistro = getdate(),
                            eliminado = 0
                        where idvehiculo = ${ body.idvehiculo };
                        --
                        ...
                        values (${ body.idconductor},${ body.idvehiculo},${ body.kmactual},'${ body.fechadetencion}','${ body.fechaalta}'
                               ,'${ body.fechareparacion }','${ body.motivo}','${ body.responsable}',${ body.reparado ? 1 : 0 },getdate(),0);
                        --
                    end;
                    --
